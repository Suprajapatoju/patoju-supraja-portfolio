        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed text-lg mb-4">
                With hands-on experience in Java, JavaScript, React.js, Node.js, and Data Structures and Algorithms, I've worked on academic and personal projects that reflect my ability to solve problems efficiently and think analytically. I'm particularly interested in Machine Learning, AI and I am actively expanding my skills in these domains through self-driven learning and internships.
              </p>
              
              <p className="text-muted-foreground leading-relaxed text-lg">
                Beyond technical abilities, I possess strong communication, leadership, and team management skills, having successfully led project teams and organized tech-related events. I enjoy collaborating with others, sharing knowledge, and contributing to innovative ideas that create value. Driven by curiosity and a growth mindset, I continuously strive to improve my expertise, explore new technologies, and become a well-rounded software engineer capable of adapting to dynamic industry needs.
              </p>
            </div>
